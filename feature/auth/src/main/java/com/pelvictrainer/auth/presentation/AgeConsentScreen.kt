...
/**
 * Экран подтверждения возраста 18+ и согласия с документами.
 * Показывается ОДИН РАЗ при первом запуске приложения.
 * Соответствует требованиям 152-ФЗ и защиты от претензий.
 */
@Composable
fun AgeConsentScreen(
    ...
    Column(
        ...
        // ===== Чекбокс 2: Политика конфиденциальности =====
        ...
        // ===== Чекбокс 4: Медицинский дисклеймер =====
        ConsentCheckboxWithLink(
        ...
        // Предупреждение о специальной категории данных
        Card(
